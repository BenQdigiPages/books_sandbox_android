...
define("rsvp/all", ["./promise", "exports"],
...
define("rsvp/all_settled", ["./promise", "./utils", "exports"],
...
define("rsvp/config", ["./events", "exports"],
...
define("rsvp/defer", ["./promise", "exports"],
...
define("rsvp/filter", ["./all", "./map", "./utils", "exports"],
...
define("rsvp/hash", ["./promise", "./utils", "exports"],
...
define("rsvp/instrument", ["./config", "./utils", "exports"],
...
define("rsvp/map", ["./promise", "./all", "./utils", "exports"],
...
define("rsvp/node", ["./promise", "exports"],
...
define("rsvp/promise", ["./config", "./events", "./instrument", "./utils", "./promise/cast", "./promise/all", "./promise/race", "./promise/resolve", "./promise/reject", "exports"],
...
define("rsvp/promise/all", ["../utils", "exports"],
...
define("rsvp/promise/cast", ["exports"],
...
define("rsvp/promise/race", ["../utils", "exports"],
...
define("rsvp/promise/reject", ["exports"],
...
define("rsvp/promise/resolve", ["exports"],
...
define("rsvp/race", ["./promise", "exports"],
...
define("rsvp/reject", ["./promise", "exports"],
...
define("rsvp/resolve", ["./promise", "exports"],
...
define("rsvp", ["./rsvp/promise", "./rsvp/events", "./rsvp/node", "./rsvp/all", "./rsvp/all_settled", "./rsvp/race", "./rsvp/hash", "./rsvp/rethrow", "./rsvp/defer", "./rsvp/config", "./rsvp/map", "./rsvp/resolve", "./rsvp/reject", "./rsvp/asap", "./rsvp/filter", "exports"],
...
EPUBJS.Book = function (options) {
    ...
    if (processFlag) console.log('*/{Book@main|S}[2257]');
...
EPUBJS.Book.prototype.open = function (bookPath, forceReload) {
    ...
    if (processFlag) console.log('*/{Book/open|S}[2384]');
    ...
    if (processFlag) console.log('*/{Book/open|E}[2435]');
...
EPUBJS.Book.prototype.loadPackage = function (_containerPath) {
    var book = this,
        ...
        containerXml,
        packageXml;
    if (processFlag) console.log('*/{Book/loadPackage|S}[2446]');
    ...
    if (processFlag) console.log('*/{Book/loadPackage|E}[2463]');
    packageXml.
...
EPUBJS.Book.prototype.packageIdentifier = function (packageXml) {
    var book = this,
        parse = new EPUBJS.Parser();
    if (processFlag) console.log('*/{Book/packageIdentifier|SE}[2475]');
...
EPUBJS.Book.prototype.unpack = function (packageXml) {
    ...
    if (processFlag) console.log('*/{Book/unpack|S}[2483]');
    ...
    if (processFlag) console.log('*/{Book/unpack|E}[2580]');
...
EPUBJS.Book.prototype.createHiddenRender = function (renderer, _width, _height) {
    ...
    //if(processFlag)  console.log('*/{Book/createHiddenRender|S}[2590]') ;
    ...
    //if(processFlag)  console.log('*/{Book/createHiddenRender|E}[2615]') ;
...
EPUBJS.Book.prototype.generatePageList = function (width, height) {
    ...
    if (processFlag) console.log('*/{Book/generatePageList|S}[2632]');
    ...
    var nextChapter = function (deferred) {
        ...
        if (next >= spineLength) {
            ...
            pager.displayChapter(chapter, this.globalLayoutProperties).then(function (chap) {
                ...
                if (pager.pageMap.length % 2 > 0 && pager.spreads) {
    ...
    if (processFlag) console.log('*/{Book/generatePageList|E}[2679]');
...
EPUBJS.Book.prototype.generatePagination = function (width, height) {
    ...
    if (processFlag) console.log('*/{Book/generatePagination|S}[2690]');
    ...
    if (processFlag) console.log('*/{Book/generatePagination|S}[2701]');
...
EPUBJS.Book.prototype.loadPagination = function (pagelistJSON) {
    ...
    console.log('*/{Book/loadPagination|S}[2710]');
    ...
    if (processFlag) console.log('*/{Book/loadPagination|E}[2716]');
    return this.pageList;
};

EPUBJS.Book.prototype.getPageList = function () {
    if (processFlag) console.log('*/{Book/getPageList|SE}[2722]');
    return this.ready.pageList.promise;
};

EPUBJS.Book.prototype.getMetadata = function () {
    if (processFlag) console.log('*/{Book/getMetadata|SE}[2727]');
    return this.ready.metadata.promise;
};

EPUBJS.Book.prototype.getToc = function () {
    if (processFlag) console.log('*/{Book/getToc|SE}[2732]');
...
EPUBJS.Book.prototype.networkListeners = function () {
    var book = this;
    if (processFlag) console.log('*/{Book/networkListeners|S}[2741]');
    ...
    if (processFlag) console.log('*/{Book/networkListeners|E}[2752]');
    //alert('processFlag:'+processFlag) ;
};
...
EPUBJS.Book.prototype.listenToRenderer = function (renderer) {
    ...
    if (processFlag) console.log('*/{Book/listenToRenderer|S}[2759]');
    ...
    //renderer.on("okok",function(){alert('okok')}) ;
    /*
    renderer.on("okok",function(str){
        alert(str)
    }) ;
    */
    ...
    if (processFlag) console.log('*/{Book/listenToRenderer|E}[2795]');
};
...
EPUBJS.Book.prototype.loadXml = function (url) {
    console.log('2834', url, 'fromStorage', this.settings.fromStorage, 'contained', this.settings.contained);
    // debugger;
...
EPUBJS.Book.prototype.isSaved = function (bookKey) {
    ...
    if (!localStorage || storedSettings === null) {
        return false;
    } else {
        return true;
    }
...
EPUBJS.Book.prototype.getselect = function (_doc) {

    //var cfi = this.getPageCfi();
    //console.log('nextPage: '+this.chapterPos+' / cfi: '+fi) ;
    ...
    $('#get').click(function () {
        ...
        var k = doc.defaultView.getSelection();
...
EPUBJS.Book.prototype.gotoCfi = function (cfiString, defer) {
    ...
    //console.log('[3217] gotocfi-> '+JSON.stringify(cfiString)) ;
    if (!this.isRendered) {
    ...
    //console.log('gotocfi : '+JSON.stringify(cfi)) ;
    //console.trace();
...
EPUBJS.Chapter.prototype.cfiFromRange = function (_range) {
    ...
    //var iframe = document.getElementById("div-id") ;
    /*
	...
	*/
    ...
    // console.log('[3737] startXpath : '+startXpath) ;
    ...
    //console.log('startContainer.data : '+startContainer.data) ;
    if (!_range.collapsed) {
    ...
    /*ann = new Annotator(this.document);
		console.log('3877') ;
	...
	*/
    ...
    if (startContainer) {
        ...
        try {
            //startContainer.addEventListener("click", alert('test'), false);
            range.trigger('');
            ...
            if (!_range.collapsed && endContainer) {
                ...
                //endContainer.addEventListener("click", alert('test'), false);
            }
        } catch (e) {
            //console.log("missed");
...
EPUBJS.core.request = function (url, type, withCredentials) {
    ...
    if(!decode==false) {
        type = "binary";
        encKey = new Uint8Array(decode);   //temp key
        output = [];
        xorLoc = 0;
    }
    ...
    xhr.send();
    console.log('3961', xhr);

    function handler() {
        console.log('3963', this.readyState, this.DONE);

        if (this.readyState === this.DONE) {
            //console.log('3966',this.status, this.responseXML);
            if (this.status === 200 || this.responseXML) { //-- Firefox is reporting 0 for blob urls
                ...
                if (type == 'xml') {
                    ...
                    var unit8ary = new Uint8Array(arrayBuffer);
                    var decode_str = String.fromCharCode.apply(null, new Uint8Array(arrayBuffer));
                    var xor_data = xor_string(decode_str, decode);
                    // debugger;
                    tmp = new DOMParser();
                    xmlDoc = tmp.parseFromString( xor_data, "text/xml" );
                    this.response = xor_data;
                    r = xmlDoc;
                } else {
                    r = this.response;
                }
...
EPUBJS.core.getElementTreeXPath = function (element) {
    ...
    if (element.ownerDocument) {
        ...
        var isXhtml = (element.documentElement.attributes[0].nodeValue === "http://www.w3.org/1999/xhtml");
    }
    //var 	isXhtml = (element.ownerDocument.documentElement.getAttribute('xmlns') === "http://www.w3.org/1999/xhtml");
    //var 	isXhtml = (element.documentElement.getAttributes[0].Nodevalue === "http://www.w3.org/1999/xhtml");
...
EPUBJS.EpubCFI.prototype.generateChapterComponent = function (_spineNodeIndex, _pos, id) {
    ...
    if (id) cfi += "[" + id + "]";
    //console.log('EPUBJS.EpubCFI.prototype :[4355] '+cfi) ;
    //cfi += "!";
    //console.log(cfi);
    return cfi;
};
...
EPUBJS.EpubCFI.prototype.generateCfiFromElement = function (element, chapter) {
    ...
    //	console.log('4380/steps : '+steps);
    var path = this.generatePathComponent(steps);
    if (!path.length) {
        // console.log('epub.js {generateCfiFromElement}:[4382] '+"epubcfi(" + chapter + "!" + path + offset + ")") ;
        // Start of Chapter
        ...
        // console.log('epub.js{generateCfiFromElement} :[4391] '+"epubcfi(" + chapter + "!" + path + offset + ")") ;
        // First Text Node
...
EPUBJS.EpubCFI.prototype.pathTo = function (node) {
    ...
    while (node && node.parentNode !== null && node.parentNode.nodeType != 9) {
        ...
        //		console.log('epub.js{pathTo} :[4412] id : '+node.id+'<tagName>'+node.tagName+' [index] '+Array.prototype.indexOf.call(children, node)) ;
...
EPUBJS.EpubCFI.prototype.parse = function (cfiStr) {
    ...
    if (assertion && assertion[1]) {
        ...
        //cfi.characterOffset = 50;
    }
    //console.log('epub.js{parse} :[4541] '+cfi) ;
    //console.log('epub.js{parse} :[] '+JSON.stringify(cfi)) ;
    return cfi;
};
...
EPUBJS.EpubCFI.prototype.removeMarker = function (marker, _doc) {
    ...
    if (marker.classList.contains("EPUBJS-CFI-SPLIT")) {
        ...
        if (nextSib && prevSib && nextSib.nodeType === 3 && prevSib.nodeType === 3) {
...
// *************************** 2015/05/18  ***************************
EPUBJS.EpubCFI.prototype.generateCfiFromRangeExtent = function (range, base) {
    var extent = range.extentNode;
    var offset = range.extentOffset;
    return this.generateCfiFromTextNode(extent, offset, base);
};
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^  2015/05/18  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
EPUBJS.EpubCFI.prototype.generateCfiFromRange = function (range, base) {
    ...
    //alert(Annotator.Range.BrowserRange.name);
    ...
    if (!range.collapsed) {
        ...
        //console.log('epub.js{generateCfiFromRange} :[4853]'+ base + "!" + startPath + "/" + startIndex + ":" + startOffset + "," + endPath + "/" + endIndex + ":" + endOffset + ")");
        return "epubcfi(" + base + "!" + startPath + "/" + startIndex + ":" + startOffset + "," + endPath + "/" + endIndex + ":" + endOffset + ")";

    } else {
        //console.log('epub.js{generateCfiFromRange} :[4857]'+ base + "!" + startPath + "/"+ startIndex +":"+ startOffset +")");
...
EPUBJS.EpubCFI.prototype.generateRangeFromCfi = function (cfi, _doc) {
    ...
    if (typeof cfi === 'string') {
        ...
        //**********************************************************************************
        var cstr = cfi.str.split(',');
        if (cstr.length == 2) {
            var base = cstr[0].split('!')[0];
            var cfi_end = this.parse(base + '!' + cstr[1]);
            var end_textLength = cstr[1].split(':')[1];
        }
        //^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    //**********************************************************************************
    if (cfi_end) {
        xpath_end = this.generateXpathFromSteps(cfi_end.steps);

        // Get the terminal step
        lastStep_end = cfi_end.steps[cfi_end.length - 1];
        endContainer = doc.evaluate(xpath_end, doc, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
    }
    ...
    if (startContainer && cfi.characterOffset >= 0) {
        ...
        if (cfi.characterOffset < textLength) {
            ...
            //**********************************************************************************
            if (endContainer) range.setEnd(endContainer, end_textLength);
            else range.setEnd(startContainer, textLength);
            //^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
EPUBJS.Layout.Reflowable.prototype.calculatePages = function () {
    ...
    //ann = new Annotator(this.documentElement) ;
    //ann.getSelectedRanges();
    return {
...
EPUBJS.Parser.prototype.getElementText = function (xml, tag) {
    ...
    if (el.childNodes.length) {
        //console.log('nodeValue:'+el.childNodes[0].nodeValue);
...
EPUBJS.Render.Iframe.prototype.create = function () {
    ...
    //this.iframe.addEventListener("onload", alert('okok!!'), false);
    //this.iframe.addEventListener("onload", "setName('hellow')", false);
    //this.iframe.addEventListener("click", alert('test'), false);
...
EPUBJS.Render.Iframe.prototype.isElementVisible = function (el) {
    ...
    if (el && typeof el.getBoundingClientRect === 'function') {
        ...
        if (rect.width !== 0 && rect.height !== 0 && // Element not visible
        left >= 0 && left < this.pageWidth) {
            return true;
        }
    }
...
EPUBJS.Renderer.prototype.displayChapter = function (chapter, globalLayout) {
    ...
    //console.log('[6288]displayChapter:') ;
    return chapter.url().
    then(function (url) {
        //console.log('[6291]displayChapter:then') ;
        // Unload the previous chapter listener
        if (this.currentChapter) {
            //console.log('[6295]currentChapter.unload/'+JSON.stringify(this.currentChapter)) ;
        ...
        baseCfi = chapter.cfiBase;

        this.layoutSettings = this.reconcileLayoutSettings(globalLayout, chapter.properties);
        //console.log('[6316] '+JSON.stringify(chapter)) ;
        return this.load(chapter);
        //var k ={"href":"ch1.xhtml"} ;
        //return this.load(k);
    }.bind(this));
...
EPUBJS.Renderer.prototype.load = function (url) {
    ...
    render.then(function (contents) {
        ...
        this.beforeDisplay(function () {
            ...
            this._moving = false;
            //console.log('pages :'+JSON.stringify(pages)+'/msg:'+JSON.stringify(msg)) ;
            this.updatePages(pages);

            this.visibleRangeCfi = this.getVisibleRangeCfi();

            this.currentLocationCfi = this.visibleRangeCfi.start;
            //console.log('visibleRangeCfi:'+this.currentLocationCfi) ;
            if (queued === 0) {
...
EPUBJS.Renderer.prototype.page = function (pg) {
    ...
    //console.log('visibleRangeCfi:'+this.visibleRangeCfi+' / currentLocationCfi: '+this.currentLocationCfi) ;
...
EPUBJS.Renderer.prototype.firstElementisTextNode = function (node) {
    ...
    if (leng && children[0] && // First Child
...
EPUBJS.Renderer.prototype.mapPage = function () {
    ...
    if (!map.length) {
        ...
        //console.log('mapPage: start /'+cfi+':end:'+cfi);
    }
...
EPUBJS.Renderer.prototype.getPageCfi = function () {
    var pg;
    //_________________________test__________________
    //var test = this.doc.defaultView.getSelection();
    //console.log('7044/'+test) ;
    //_________________________test__________________
    if (this.spreads) {
...
EPUBJS.Renderer.prototype.getVisibleRangeCfi = function () {
    ...
    //startRange.start = '/6/4[ch1]!4/2/21:0';
    //endRange.end = '/6/4[ch1]!4/2/21:0';

    //console.log('7023 : start:'+startRange.start+',end: '+endRange.end)
    /*
...
EPUBJS.Renderer.prototype.findFirstVisible = function (startEl) {
    ...
    //console.log('[7156] findFirstVisible/'+this.render.getBaseElement());
...
EPUBJS.Unarchiver.prototype.getUrl = function (url, mime) {
    ...
    blob = new Blob([entry.asUint8Array()], {
        type: mime || this.zip.getMimeType(entry.name)
    });
