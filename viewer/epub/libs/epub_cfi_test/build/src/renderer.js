...
//console.log('[startRange]'+startRange.start+'/[endRange]'+endRange.end);
...
EPUBJS.Renderer.prototype.findElementAfter = function(x, y, startEl){
	var el = startEl || this.render.getBaseElement();
	var	found;
console.log('findElementAfter : '+findElementAfter);
...
console.log('Renderer.onResized') ;
...
EPUBJS.Renderer.prototype.addEventListeners = function(){
	...
	console.log('Renderer.addEventListeners') ;
